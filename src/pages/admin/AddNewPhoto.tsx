    ...
    <>
      ...
      <div className="bg-surface p-8 rounded-lg border border-border">
        <form className="space-y-3">
          <div>
            <label className="block text-sm font-medium text-text-secondary mb-2" htmlFor="file-upload">
              Media File
            </label>
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                className="block w-full rounded-md border-0 py-2.5 bg-background text-text-primary shadow-sm ring-1 ring-inset ring-border placeholder:text-text-placeholder focus:ring-2 focus:ring-inset focus:ring-primary-DEFAULT sm:text-sm sm:leading-6"
                id="title"
                name="title"
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                id="tags"
                name="tags"
                placeholder="abstract, colorful, modern, sticker"
                type="text"
              />
