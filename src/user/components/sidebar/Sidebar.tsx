...
import { clearCategories, resetFilters, toggleAccessType, toggleCategory, togglePhotoType, toggleTag } from '../../../store/slices/imagesFilterSlice'
  ...
  return (
    <aside
      className={`
            ...
            overflow-hidden
            ${isOpen ? 'w-[100vw] max-w-[430px] md:w-[430px]' : 'w-0'}
          `}>
      {/* <!-- Header --> */}
      <div className="max-w-[430px] h-full flex flex-col">
